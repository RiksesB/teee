...
export const Login = () => {
  ...
  React.useEffect(() => {
    const savedEmail = localStorage.getItem('niblion_remember_email');
    if (savedEmail) {
      setEmail(savedEmail);
      setRememberMe(true);
    }
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      if (rememberMe) {
        localStorage.setItem('niblion_remember_email', email);
      } else {
        localStorage.removeItem('niblion_remember_email');
      }
      ...
      <div className="max-w-md w-full space-y-6 sm:space-y-8">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="appearance-none relative block w-full px-3 sm:px-4 py-2 sm:py-3 pr-10 border border-gray-300 placeholder-gray-400 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all text-sm sm:text-base"
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <div className="text-xs text-blue-700 space-y-1.5">
            <div>
              <strong>Admin:</strong> super@niblion.com / super123
            </div>
            <div>
