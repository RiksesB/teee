...
export const MODULOS: Record<number, Modulo> = {
  1: {
  ...
  2: {
    ...
    preguntas: [
      ...
      },
      {
        numero: 2,
        pregunta:
          'Recibes un correo urgente del "banco" pidiendo tus datos. ¿Qué haces?',
        opciones: [
  ...
  3: {
    ...
    preguntas: [
      ...
      },
      {
        numero: 2,
        pregunta:
          'Ves un video viral de alguien famoso diciendo algo raro. ¿Qué haces?',
        opciones: [
  ...
  4: {
    ...
    preguntas: [
      ...
      },
      {
        numero: 2,
        pregunta:
          'Una app que descargaste pide permisos para acceder a tu cámara, micrófono y contactos. ¿Qué haces?',
        opciones: [
  ...
  5: {
    ...
    preguntas: [
      ...
      },
      {
        numero: 2,
        pregunta:
          'Recibes un enlace por WhatsApp de un desconocido. ¿Qué haces?',
        opciones: [
...
export const ENCUESTA_SATISFACCION = [
  {
    numero: 1,
